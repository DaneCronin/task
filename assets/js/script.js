...
//task handler function to find ID for all tasks
var taskButtonHandler = function(event) {
    ...
    // delete button was clicked
        ...
        //get the element's task id to target correct element
...
var completeEditTask = function(taskName, taskType, taskId) {
    ...
    //set new values, names, for the new task
    ...
    //reset form by removing task Id and change button back to normal
...
// Function to handle status change from to-do, in-progress, completed
var taskStatusChangeHandler = function(event) {
    ...
    //for loop to update task's status in tasks array
    for (var i = 0; i <tasks.length; i++) {
        if (tasks[i].id === parseInt(taskId)) {
